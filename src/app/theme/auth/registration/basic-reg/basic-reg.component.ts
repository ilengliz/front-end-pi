...
onFileSelected(event) {
  ...
  onSignUp(form: NgForm) {
    ...
    console.log(typeof this.mygender);
console.log(typeof this.profilePicture);
    // this.mygender = form.controls['gender'].value;
console.log(form.value['firstname']);

this.signUpService.signUp (form.value['firstname'], form.value['lastname'],
form.value['email'], form.value['cin'],
form.value['jobPost'], form.value['mobileNumber'], this.profilePicture, form.value['gender'], form.value['password']);
